...
if [[ "$target_platform" == "osx-64" ]]; then
    EXTRA_CMAKE_ARGS="-DDARWIN_osx_ARCHS=x86_64;arm64 -DCOMPILER_RT_ENABLE_IOS=Off -DCMAKE_OSX_DEPLOYMENT_TARGET=${MACOSX_DEPLOYMENT_TARGET} -DCOMPILER_RT_BUILD_SANITIZERS=no"
