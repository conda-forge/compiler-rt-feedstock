...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/compiler-rt-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/compiler-rt-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add compiler-rt compiler-rt21 compiler-rt21_linux-64 compiler-rt_linux-64 libcompiler-rt
# for installing globally
pixi global install compiler-rt compiler-rt21 compiler-rt21_linux-64 compiler-rt_linux-64 libcompiler-rt
```
...
It is possible to list all of the versions of `compiler-rt` available on your platform:
